...
-- Which two states have the most teams, and how many each?
 California has 4 teams, Texas has 3 teams.


-- In query 6 you used both WHERE and HAVING. Explain in your own
 words what each one filtered.
 WHERE filtered individual row records before grouping took place 
 HAVING filtered aggregated group results after grouping took place
...
-- GROUP BY: Combines rows that share identical values in specified columns 
