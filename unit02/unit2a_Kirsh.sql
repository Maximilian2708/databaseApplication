...
Bostion Celtics, 1946

-- =====================================================================
-- VOCABULARY — your words, not the reference sheet's
-- =====================================================================

-- Query: what you put into the computer to get what youre looking for from the db


-- Clause: a statement that specifies a condition on a query


-- Alias (AS): renames a column or table in a query to make it more human like
