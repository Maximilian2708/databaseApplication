...
Query 1 show players who have stats and query 2 shows those who dont have stats for the 2025-26 season

-- In query 3 you filtered with IS NULL. Which table did that NULL
-- come from, and why is it NULL?
The null comes from the amount of data in the player stats

-- =====================================================================
-- VOCABULARY — your words, not the reference sheet's
-- =====================================================================

-- LEFT JOIN: Joins two tables from the same database


-- Export: downloading something